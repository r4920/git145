import '../incoming_group_call_notification_screen/widgets/group314_item_widget.dart';
import '../incoming_group_call_notification_screen/widgets/group315_item_widget.dart';
import 'controller/incoming_group_call_notification_controller.dart';
import 'models/group314_item_model.dart';
import 'models/group315_item_model.dart';
                                  ...
                                  Obx(
                                    () => ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        Group314ItemModel model = controller
                                            .incomingGroupCallNotificationModelObj
                                            .value
                                            .group314ItemList[index];
                                        return Group314ItemWidget(
                                          model,
                                        );
                                      },
                                    ),
                                  ...
                                  Obx(
                                    () => ListView.builder(
                                      ...
                                      itemCount: controller
                                          ...
                                          .length,
                                      itemBuilder: (context, index) {
                                        Group315ItemModel model = controller
                                            .incomingGroupCallNotificationModelObj
                                            .value
                                            .group315ItemList[index];
                                        return Group315ItemWidget(
                                          model,
                                        );
                                      },
                                    ),
