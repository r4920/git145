...
class Group249ItemWidget extends StatelessWidget {
  Group249ItemWidget(this.group249ItemModelObj);

  Group249ItemModel group249ItemModelObj;

  var controller =
      Get.find<IncomingCallNotificationMoreThanOneProfileController>();
