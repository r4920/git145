import '../incoming_call_notification_more_than_one_profile_screen/widgets/group248_item_widget.dart';
import '../incoming_call_notification_more_than_one_profile_screen/widgets/group249_item_widget.dart';
import 'controller/incoming_call_notification_more_than_one_profile_controller.dart';
import 'models/group248_item_model.dart';
import 'models/group249_item_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:rahul_s_application50/core/app_export.dart';

class IncomingCallNotificationMoreThanOneProfileScreen
    extends GetWidget<IncomingCallNotificationMoreThanOneProfileController> {
  @override
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.asset(
                                              ImageConstant.imgTelegramlogo1,
                                              height: getSize(
                                                17.00,
                                              ),
                                              width: getSize(
                                  ...
                                  Obx(
                                    () => ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        Group248ItemModel model = controller
                                            .incomingCallNotificationMoreThanOneProfileModelObj
                                            .value
                                  ...
                                  Obx(
                                    () => ListView.builder(
                                      ...
                                      itemCount: controller
                                          ...
                                          .length,
                                      itemBuilder: (context, index) {
                                        Group249ItemModel model = controller
                                            .incomingCallNotificationMoreThanOneProfileModelObj
                                            .value
                                            .group249ItemList[index];
                                        return Group249ItemWidget(
                                          model,
                                        );
                                      },
                                    ),
